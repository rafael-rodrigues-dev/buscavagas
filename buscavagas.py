...
app.title('Busca Vagas')
app.geometry('500x500')
app.configure(background='#1d004d')
...
# Texts and inputs
Label(app, text='Digite a vaga desejada:', bg='#1d004d', fg='white', font='Kollektif', anchor=W).place(x=40, y=200)
Label(app, text='Digite a cidade:', bg='#1d004d', fg='white', font='Kollektif', anchor=W).place(x=40, y=260)
input_job = Entry(app, font='Kollektif')
input_job.place(x=40, y=230, width=400, height=25)
input_city = Entry(app, font='Kollektif')
input_city.place(x=40, y=290, width=400, height=25)
